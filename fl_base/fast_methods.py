# This file is modified variant of https://gitlab.aicrowd.com/flatland/flatland/-/tree/master/flatland/envs/fast_methods.py
# see methods at the end of file
...
# added
def my_fast_where(param, int_position):
    return [index for index, element in enumerate(param) if element == int_position]
# added
def my_fast_where_not(param, val):
    return [index for index, element in enumerate(param) if element != val]
